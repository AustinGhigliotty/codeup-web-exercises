...
var originalPrice = prompt("What was the original price?");
var discountPercentVar = prompt("What is the discount percentage?");
alert("The new price is $" + applyDiscount(originalPrice,discountPercentVar));
